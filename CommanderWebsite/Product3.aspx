                                    ...
                                    <li class="widget-categories__item" data-collapse-item="">
                                        <div class="widget-categories__row"><a href="#">
                                            <svg class="widget-categories__arrow" width="6px" height="9px">
                                                <use xlink:href="Assets/images/sprite.svg#arrow-rounded-right-6x9"></use></svg>
                                            Power Tools </a>
                    ...
                    <div class="block">
                        <div class="product product--layout--sidebar" data-layout="sidebar">
                            <div class="product__content">
                                ...
                                <div class="product__gallery">
                                    <div class="product-gallery">
                                        <div class="product-gallery__featured">
                                            <button class="product-gallery__zoom" type="button">
                                                <svg width="24px" height="24px">
                                                    <use xlink:href="Assets/images/sprite.svg#zoom-in-24"></use></svg></button><div class="owl-carousel owl-loaded owl-drag" id="product-image">
                                ...
                                -->
                                                                        <a href="Assets/images/products/product-16.jpg" data-width="700" data-height="700" class="product-image__body" target="_blank">
                                                                            <img class="product-image__img" src="Assets/images/products/product-16.jpg" alt="" /></a>
                                                                    </div>
                                                                </div>
                                ...
                                and naturalHeight property of img.product-image__img.
                                -->
                                                                        <a href="Assets/images/products/product-16-1.jpg" data-width="700" data-height="700" class="product-image__body" target="_blank">
                                                                            <img class="product-image__img" src="Assets/images/products/product-16-1.jpg" alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div class="owl-item" style="width: 392.5px;">
                                                                    <div class="product-image product-image--location--gallery">
                                ...
                                and naturalHeight property of img.product-image__img.
                                -->
                                                                        <a href="Assets/images/products/product-16-2.jpg" data-width="700" data-height="700" class="product-image__body" target="_blank">
                                                                            <img class="product-image__img" src="Assets/images/products/product-16-2.jpg" alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div class="owl-item" style="width: 392.5px;">
                                                                    <div class="product-image product-image--location--gallery">
                                ...
                                and naturalHeight property of img.product-image__img.
                                -->
                                                                        <a href="Assets/images/products/product-16-3.jpg" data-width="700" data-height="700" class="product-image__body" target="_blank">
                                                                            <img class="product-image__img" src="Assets/images/products/product-16-3.jpg" alt="" /></a>
                                                                    </div>
                                                                </div>
                                                                <div class="owl-item" style="width: 392.5px;">
                                                                    <div class="product-image product-image--location--gallery">
                                ...
                                and naturalHeight property of img.product-image__img.
                                -->
                                                                        <a href="Assets/images/products/product-16-4.jpg" data-width="700" data-height="700" class="product-image__body" target="_blank">
                                                                            <img class="product-image__img" src="Assets/images/products/product-16-4.jpg" alt="" /></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="owl-carousel owl-loaded owl-drag" id="product-carousel">
                                                <div class="owl-stage-outer">
                                                    <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 509px;">
                                                        <div class="owl-item active" style="width: 91.625px; margin-right: 10px;"><a href="Assets/images/products/product-16.jpg" class="product-image product-gallery__carousel-item product-gallery__carousel-item--active">
                                                            <div class="product-image__body">
                                                                <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16.jpg" alt="" /></div>
                                                        </a></div>
                                                        <div class="owl-item active" style="width: 91.625px; margin-right: 10px;"><a href="Assets/images/products/product-16-1.jpg" class="product-image product-gallery__carousel-item">
                                                            <div class="product-image__body">
                                                                <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16-1.jpg" alt="" /></div>
                                                        </a></div>
                                                        <div class="owl-item active" style="width: 91.625px; margin-right: 10px;"><a href="Assets/images/products/product-16-2.jpg" class="product-image product-gallery__carousel-item">
                                                            <div class="product-image__body">
                                                                <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16-2.jpg" alt="" /></div>
                                                        </a></div>
                                                        <div class="owl-item active" style="width: 91.625px; margin-right: 10px;"><a href="Assets/images/products/product-16-3.jpg" class="product-image product-gallery__carousel-item">
                                                            <div class="product-image__body">
                                                                <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16-3.jpg" alt="" /></div>
                                                        </a></div>
                                                        <div class="owl-item" style="width: 91.625px; margin-right: 10px;"><a href="Assets/images/products/product-16-4.jpg" class="product-image product-gallery__carousel-item">
                                                            <div class="product-image__body">
                                                                <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16-4.jpg" alt="" /></div>
                                                        </a></div>
                                                    </div>
                                                </div>
                                                <div class="owl-nav disabled">
                                    ...
                                    <div class="product__wishlist-compare">
                                        <button type="button" class="btn btn-sm btn-light btn-svg-icon" data-toggle="tooltip" data-placement="right" title="" data-original-title="Wishlist">
                                            <svg width="16px" height="16px">
                                                <use xlink:href="Assets/images/sprite.svg#wishlist-16"></use></svg></button>
                                        <button type="button" class="btn btn-sm btn-light btn-svg-icon" data-toggle="tooltip" data-placement="right" title="" data-original-title="Compare">
                                            <svg width="16px" height="16px">
                                                <use xlink:href="Assets/images/sprite.svg#compare-16"></use></svg></button></div>
                                            ...
                                            <label class="product__option-label" for="product-quantity">Quantity</label><div class="product__actions">
                                                ...
                                                <div class="product__actions-item product__actions-item--wishlist">
                                                    <button type="button" class="btn btn-secondary btn-svg-icon btn-lg" data-toggle="tooltip" title="" data-original-title="Wishlist">
                                                        <svg width="16px" height="16px">
                                                            <use xlink:href="Assets/images/sprite.svg#wishlist-16"></use></svg></button></div>
                                        ...
                                        <div class="reviews-list">
                                            <ol class="reviews-list__content">
                                                <li class="reviews-list__item">
                                                    <div class="review">
                                                        <div class="review__avatar">
                                                            <img src="Assets/images/avatars/avatar-1.jpg" alt="" /></div>
                                                ...
                                                <li class="reviews-list__item">
                                                    <div class="review">
                                                        <div class="review__avatar">
                                                            <img src="Assets/images/avatars/avatar-2.jpg" alt="" /></div>
                                                        <div class="review__content">
                        ...
                        <div class="block-header__arrows-list">
                            <button class="block-header__arrow block-header__arrow--left" type="button">
                                <svg width="7px" height="11px">
                                    <use xlink:href="Assets/images/sprite.svg#arrow-rounded-left-7x11"></use></svg></button>
                            <button class="block-header__arrow block-header__arrow--right" type="button">
                                <svg width="7px" height="11px">
                                    <use xlink:href="Assets/images/sprite.svg#arrow-rounded-right-7x11"></use></svg></button></div>
                    </div>
