<%@ Page Title="CheckOut" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="CommanderWebsite.CheckOut" %>
                        ...
                        <div class="card mb-lg-0">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="checkout-country" class="form-control form-control-select2 select2-hidden-accessible" data-select2-id="checkout-country" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="2">Select a country...</option>
                                ...
                                <div class="form-group">
                                    <div class="form-check"><span class="form-check-input input-check"><span class="input-check__body">
                                        ...
                                        <label class="form-check-label" for="checkout-create-account">Create an account?</label></div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="form-check"><span class="form-check-input input-check"><span class="input-check__body">
                                        ...
                                        <label class="form-check-label" for="checkout-different-address">Ship to a different address?</label></div>
                                </div>
                                <div class="form-group">
                                    <label for="checkout-comment">Order notes <span class="text-muted">(Optional)</span></label>
                                    <textarea id="checkout-comment" class="form-control" rows="4"></textarea></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="checkout__agree form-group">
                                    <div class="form-check"><span class="form-check-input input-check"><span class="input-check__body">
                                        ...
                                        <label class="form-check-label" for="checkout-terms">I have read and agree to the website <a target="_blank" href="terms-and-conditions.html">terms and conditions</a>*</label></div>
                                </div>
                                <button type="submit" class="btn btn-primary btn-xl btn-block">Place Order</button></div>
                        </div>
                    </div>
                </div>
            </div>
