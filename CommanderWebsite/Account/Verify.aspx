<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Verify.aspx.cs" Inherits="CommanderWebsite.Account.Verify" %>
                                        ...
                                        <div class="card">
                                            <div class="card-body  ">
                                                ...
                                                <div class="alert alert-success alert-sa-has-icon mt-4 mb-4" role="alert">
                                                    ...
                                                    <div class="alert-sa-content">A confirmation email has been sent to <strong><%:User.Identity.Name %></strong>.</div>
                                                </div>
