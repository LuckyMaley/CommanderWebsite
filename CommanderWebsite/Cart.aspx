<%@ Page Title="Cart" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="CommanderWebsite.Cart" %>
            ...
            <div class="container">
                <table class="cart__table cart-table">
                    ...
                    <tbody class="cart-table__body">
                        <tr class="cart-table__row">
                            ...
                            <td class="cart-table__column cart-table__column--product"><a href="Product.aspx" class="cart-table__product-name">Electric Planer Brandix KL370090G 300 Watts</a><ul class="cart-table__options">
                                <li>Color: Yellow</li>
                            ...
                            <td class="cart-table__column cart-table__column--remove">
                                <button type="button" class="btn btn-light btn-sm btn-svg-icon">
                                    <svg width="12px" height="12px">
                                        <use xlink:href="Assets/images/sprite.svg#cross-12"></use></svg></button></td>
                        </tr>
                        <tr class="cart-table__row">
                            <td class="cart-table__column cart-table__column--image">
                                <div class="product-image"><a href="Product.aspx" class="product-image__body">
                            ...
                            <td class="cart-table__column cart-table__column--product"><a href="Product.aspx" class="cart-table__product-name">Undefined Tool IRadix DPS3000SY 2700 watts</a></td>
                        ...
                        <tr class="cart-table__row">
                            ...
                            <td class="cart-table__column cart-table__column--product"><a href="Product.aspx" class="cart-table__product-name">Brandix Router Power Tool 2017ERXPK</a><ul class="cart-table__options">
                ...
                <div class="cart__actions">
                    <div class="cart__coupon-form">
                        ...
                        <button type="submit" class="btn btn-primary">Apply Coupon</button></div>
                    <div class="cart__buttons"><a href="\" class="btn btn-light">Continue Shopping</a> <a href="#" class="btn btn-primary cart__update-button">Update Cart</a></div>
                </div>
                    ...
                    <div class="col-12 col-md-7 col-lg-6 col-xl-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary btn-xl btn-block cart__checkout-button" href="CheckOut.aspx">Proceed to checkout</a></div>
                        </div>
                    </div>
                </div>
            </div>
