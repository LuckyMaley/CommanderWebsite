                ...
                <div class="col-12 col-lg-8">
                    <div class="block post post--layout--classic">
                        ...
                        <div class="post__featured"><a href="">
                            <img src="images/posts/post-featured.jpg" alt=""></a></div>
                        <div class="post__content typography">
                            ...
                            <figure><a href="">
                                <img src="images/posts/post-featured.jpg" alt=""></a><figcaption>Nunc viverra, dui nec commodo dignissim, libero arcu.</figcaption></figure>
                        ...
                        <div class="post__footer">
                            ...
                            <div class="post-author">
                                <div class="post-author__avatar"><a href="">
                                    <img src="images/avatars/avatar-1.jpg" alt=""></a></div>
                        ...
                        <section class="post__section">
                            ...
                            <ol class="comments-list comments-list--level--0">
                                    ...
                                    <div class="comment-list__children">
                                        <ol class="comments-list comments-list--level--1">
                                            <li class="comments-list__item">
                                                <div class="comment">
                                                    <div class="comment__avatar"><a href="">
                                                        <img src="images/avatars/avatar-2.jpg" alt=""></a></div>
                                                    <div class="comment__content">
                                                        <div class="comment__header">
                                            ...
                                            <li class="comments-list__item">
                                                <div class="comment">
                                                    <div class="comment__avatar"><a href="">
                                                        <img src="images/avatars/avatar-3.jpg" alt=""></a></div>
                                                    <div class="comment__content">
                                                        <div class="comment__header">
                                ...
                                <li class="comments-list__item">
                                    <div class="comment">
                                        <div class="comment__avatar"><a href="">
                                            <img src="images/avatars/avatar-4.jpg" alt=""></a></div>
                                        <div class="comment__content">
                                            <div class="comment__header">
                                ...
                                <form class="widget-search__body">
                                    ...
                                    <button class="widget-search__button" type="submit">
                                        <svg width="20px" height="20px">
                                            <use xlink:href="images/sprite.svg#search-20"></use></svg></button></form>
                            </div>
                        </div>
                        <div class="block-sidebar__item">
                                ...
                                <div class="widget-posts__list">
                                    <div class="widget-posts__item">
                                        <div class="widget-posts__image"><a href="">
                                            <img src="images/posts/post-1-thumbnail.jpg" alt=""></a></div>
                                    ...
                                    <div class="widget-posts__item">
                                        <div class="widget-posts__image"><a href="">
                                            <img src="images/posts/post-2-thumbnail.jpg" alt=""></a></div>
                                        <div class="widget-posts__info">
                                    ...
                                    <div class="widget-posts__item">
                                        <div class="widget-posts__image"><a href="">
                                            <img src="images/posts/post-3-thumbnail.jpg" alt=""></a></div>
                                        <div class="widget-posts__info">
                        ...
                        <div class="block-sidebar__item">
                            <div class="widget-newsletter widget">
                                ...
                                <form class="widget-newsletter__form" action="">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-3">Subscribe</button></form>
                            </div>
                        </div>
                        <div class="block-sidebar__item">
