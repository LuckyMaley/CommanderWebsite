<%@ Page Title="Blog Post" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="BlogPost.aspx.cs" Inherits="CommanderWebsite.BlogPost" %>
            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    <div class="block post post--layout--classic">
                        ...
                        <div class="post__featured"><a href="#">
                            <img src="Assets/images/posts/post-featured.jpg" alt="" /></a></div>
                        <div class="post__content typography">
                            ...
                            <figure><a href="#">
                                <img src="Assets/images/posts/post-featured.jpg" alt="" /></a><figcaption>Nunc viverra, dui nec commodo dignissim, libero arcu.</figcaption></figure>
                        ...
                        <div class="post__footer">
                            ...
                            <div class="post-author">
                                <div class="post-author__avatar"><a href="#">
                                    <img src="Assets/images/avatars/avatar-1.jpg" alt="" /></a></div>
                                ...
                                <div class="related-posts__list">
                                    <div class="related-posts__item post-card post-card--layout--related">
                                        <div class="post-card__image"><a href="#">
                                            <img src="Assets/images/posts/post-1.jpg" alt="" /></a></div>
                                    ...
                                    <div class="related-posts__item post-card post-card--layout--related">
                                        <div class="post-card__image"><a href="#">
                                            <img src="Assets/images/posts/post-2.jpg" alt="" /></a></div>
                                        <div class="post-card__info">
                        ...
                        <section class="post__section">
                            ...
                            <ol class="comments-list comments-list--level--0">
                                        ...
                                        <div class="comment__content">
                                            <div class="comment__header">
                                                ...
                                                <div class="comment__reply">
                                                    <button type="button" class="btn btn-xs btn-light">Reply</button></div>
                                            </div>
                                    ...
                                    <div class="comment-list__children">
                                        <ol class="comments-list comments-list--level--1">
                                            <li class="comments-list__item">
                                                <div class="comment">
                                                    <div class="comment__avatar"><a href="#">
                                                        <img src="Assets/images/avatars/avatar-2.jpg" alt="" /></a></div>
                                                    <div class="comment__content">
                                                        <div class="comment__header">
                                            ...
                                            <li class="comments-list__item">
                                                <div class="comment">
                                                    <div class="comment__avatar"><a href="#">
                                                        <img src="Assets/images/avatars/avatar-3.jpg" alt="" /></a></div>
                                                    <div class="comment__content">
                                                        <div class="comment__header">
                                ...
                                <li class="comments-list__item">
                                    <div class="comment">
                                        <div class="comment__avatar"><a href="#">
                                            <img src="Assets/images/avatars/avatar-4.jpg" alt=""/></a></div>
                                        <div class="comment__content">
                                            <div class="comment__header">
                            ...
                            <div>
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="comment-first-name" placeholder="First Name" /></div>
                                    <div class="form-group col-md-4">
                                        <label for="comment-last-name">Last Name</label>
                                        <input type="text" class="form-control" id="comment-last-name" placeholder="Last Name" /></div>
                                    <div class="form-group col-md-4">
                                        <label for="comment-email">Email Address</label>
                                        <input type="email" class="form-control" id="comment-email" placeholder="Email Address" /></div>
                                </div>
                                <div class="form-group">
                                    <label for="comment-content">Comment</label>
                                    <textarea class="form-control" id="comment-content" rows="6"></textarea></div>
                                <div class="form-group mt-4">
                                    <button type="submit" class="btn btn-primary btn-lg">Post Comment</button></div>
                            </div>
                        </section>
                    </div>
                </div>
                                ...
                                <div class="widget-search__body">
                                    ...
                                    <button class="widget-search__button" type="submit">
                                        <svg width="20px" height="20px">
                                            <use xlink:href="Assets/images/sprite.svg#search-20"></use></svg></button></div>
                            </div>
                        </div>
                        <div class="block-sidebar__item">
                            ...
                            <div class="widget-posts widget">
                                ...
                                <div class="widget-posts__list">
                                    <div class="widget-posts__item">
                                        <div class="widget-posts__image"><a href="#">
                                            <img src="Assets/images/posts/post-1-thumbnail.jpg" alt="" /></a></div>
                                    ...
                                    <div class="widget-posts__item">
                                        <div class="widget-posts__image"><a href="#">
                                            <img src="Assets/images/posts/post-2-thumbnail.jpg" alt="" /></a></div>
                                        <div class="widget-posts__info">
                                    ...
                                    <div class="widget-posts__item">
                                        <div class="widget-posts__image"><a href="#">
                                            <img src="Assets/images/posts/post-3-thumbnail.jpg" alt="" /></a></div>
                                        <div class="widget-posts__info">
                        ...
                        <div class="block-sidebar__item">
                            <div class="widget-newsletter widget">
                                ...
                                <div class="widget-newsletter__form">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-3">Subscribe</button></div>
                            </div>
                        </div>
                        <div class="block-sidebar__item">
