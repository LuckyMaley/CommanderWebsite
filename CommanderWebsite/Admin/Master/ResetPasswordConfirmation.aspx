<%@ Page Title="Reset Confirmation" Language="C#" AutoEventWireup="true" CodeBehind="ResetPasswordConfirmation.aspx.cs" Inherits="CommanderWebsite.Admin.Master.ResetPasswordConfirmation" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="card w-25x flex-grow-1 flex-sm-grow-0 m-sm-auto">
                <div class="card-body p-sm-5 m-sm-3 flex-grow-0">
                    ...
                    <div>
                        <p>Your password has been changed.  <asp:HyperLink ID="login" runat="server" NavigateUrl="~/Admin/Master/SignIn">Click here</asp:HyperLink> to go to login </p>
                    </div>
                    </div>
                    </div></div>
