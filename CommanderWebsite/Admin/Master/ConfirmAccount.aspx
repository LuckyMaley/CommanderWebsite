<%@ Page Title="Confirm Account" Language="C#" AutoEventWireup="true" CodeBehind="ConfirmAccount.aspx.cs" Inherits="CommanderWebsite.Admin.Master.ConfirmAccount" %>
            ...
            <div class="card w-25x flex-grow-1 flex-sm-grow-0 m-sm-auto">
                ...
                <div class="card-body p-sm-5 m-sm-3 flex-grow-0">
                    ...
                    <div class="alert alert-success alert-sa-has-icon mt-4 mb-4" role="alert">
                        ...
                        <div class="alert-sa-content">The email account: <strong><%:User.Identity.Name %></strong> has been verified successfully .</div>
                    </div>
