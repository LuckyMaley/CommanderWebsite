                                        ...
                                        <table class="sa-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                            <img src="images/products/product-16-1-40x40.jpg" width="40" height="40" alt=""></div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                            <img src="images/products/product-16-2-40x40.jpg" width="40" height="40" alt=""></div>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm"></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                            <img src="images/products/product-16-3-40x40.jpg" width="40" height="40" alt=""></div>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm"></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                            <img src="images/products/product-16-4-40x40.jpg" width="40" height="40" alt=""></div>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm"></td>
                                                    <td>
