<%@ Page Title="General" Language="C#" MasterPageFile="~/Admin/Master/AdminSite.Master" AutoEventWireup="true" CodeBehind="General.aspx.cs" Inherits="CommanderWebsite.Admin.Master.General" %>
            ...
            <div class="container container--max--lg">
                ...
                <div class="card mt-5">
                    <div class="card-body p-5">
                        ...
                        <div class="mb-4">
                            <label for="form-settings/timezone" class="form-label">Timezone</label><select id="form-settings/timezone" class="form-select"><option>Europe/Berlin</option>
                        ...
                        <div class="mb-4">
                            <label for="form-settings/date-format" class="form-label">Date Format</label><select id="form-settings/date-format" class="form-select"><option selected="">October 19, 2020 (F j, Y)</option>
                        ...
                        <div>
                            <label for="form-settings/time-format" class="form-label">Time Format</label><select id="form-settings/time-format" class="form-select"><option selected="">10:57 am (g:i a)</option>
