                                    ...
                                    <div class="owl-carousel owl-loaded owl-drag" id="product-carousel">
                                        <div class="owl-stage-outer">
                                            <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 488px;">
                                                <div class="owl-item active" style="width: 87.5px; margin-right: 10px;"><a href="Assets/images/products/product-16.jpg" class="product-image product-gallery__carousel-item product-gallery__carousel-item--active">
                                                    <div class="product-image__body">
                                                        <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16.jpg" alt="" /></div>
                                                </a></div>
                                                <div class="owl-item active" style="width: 87.5px; margin-right: 10px;"><a href="Assets/images/products/product-16-1.jpg" class="product-image product-gallery__carousel-item">
                                                    <div class="product-image__body">
                                                        <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16-1.jpg" alt="" /></div>
                                                </a></div>
                                                <div class="owl-item active" style="width: 87.5px; margin-right: 10px;"><a href="Assets/images/products/product-16-2.jpg" class="product-image product-gallery__carousel-item">
                                                    <div class="product-image__body">
                                                        <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16-2.jpg" alt="" /></div>
                                                </a></div>
                                                <div class="owl-item active" style="width: 87.5px; margin-right: 10px;"><a href="Assets/images/products/product-16-3.jpg" class="product-image product-gallery__carousel-item">
                                                    <div class="product-image__body">
                                                        <img class="product-image__img product-gallery__carousel-image" src="Assets/images/products/product-16-3.jpg" alt="" /></div>
                                                </a></div>
                                                <div class="owl-item" style="width: 87.5px; margin-right: 10px;"><a href="Assets/images/products/product-16-4.jpg" class="product-image product-gallery__carousel-item">
                                                    <div class="product-image__body">
