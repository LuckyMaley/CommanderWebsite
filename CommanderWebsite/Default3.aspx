<%@ Page Title="Home3" Language="C#" MasterPageFile="~/Site4.Master" AutoEventWireup="true" CodeBehind="Default3.aspx.cs" Inherits="CommanderWebsite.Default3" %>
                                    ...
                                    <div class="block-finder__form">
                                        <div class="block-finder__form-item">
                                            <select class="block-finder__select select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                ...
                                                <option data-select2-id="18">2010</option>
                                                <option data-select2-id="19">2011</option>
                                                <option data-select2-id="20">2012</option>
                                                <option data-select2-id="21">2013</option>
                                                <option data-select2-id="22">2014</option>
                                                <option data-select2-id="23">2015</option>
                                                <option data-select2-id="24">2016</option>
                                                <option data-select2-id="25">2017</option>
                                                <option data-select2-id="26">2018</option>
                                                <option data-select2-id="27">2019</option>
                                                <option data-select2-id="28">2020</option>
                                            </select><span class="select2 select2-container select2-container--default select2-container--below" dir="ltr" data-select2-id="2"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-aerr-container"><span class="select2-selection__rendered" id="select2-aerr-container" role="textbox" aria-readonly="true" title="Select Year">Select Year</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></div>
                                        <div class="block-finder__form-item">
                                            ...
                                            </select><span class="select2 select2-container select2-container--default select2-container--disabled" dir="ltr" data-select2-id="5"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="true" aria-labelledby="select2-2ob3-container"><span class="select2-selection__rendered" id="select2-2ob3-container" role="textbox" aria-readonly="true" title="Select Make">Select Make</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></div>
                                        <div class="block-finder__form-item">
                                            ...
                                            </select><span class="select2 select2-container select2-container--default select2-container--disabled select2-container--focus" dir="ltr" data-select2-id="8"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="true" aria-labelledby="select2-2ej0-container"><span class="select2-selection__rendered" id="select2-2ej0-container" role="textbox" aria-readonly="true" title="Select Model">Select Model</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></div>
                                        <div class="block-finder__form-item">
                                            ...
                                            </select><span class="select2 select2-container select2-container--default select2-container--disabled" dir="ltr" data-select2-id="11"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="true" aria-labelledby="select2-5nat-container"><span class="select2-selection__rendered" id="select2-5nat-container" role="textbox" aria-readonly="true" title="Select Engine">Select Engine</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></div>
                                    </div>
                ...
                <div class="container">
                    <div class="block-header">
                        ...
                        <div class="block-header__arrows-list">
                            <button class="block-header__arrow block-header__arrow--left" type="button"><svg width="7px" height="11px"><use xlink:href="images/sprite.svg#arrow-rounded-left-7x11"></use></svg></button>
                            <button class="block-header__arrow block-header__arrow--right" type="button"><svg width="7px" height="11px"><use xlink:href="images/sprite.svg#arrow-rounded-right-7x11"></use></svg></button>
                        </div>
                    </div>
                                            ...
                                            <div class="product-card__rating">
                                                <div class="rating">
                                                    <div class="rating__body">
                                                        <svg class="rating__star rating__star--active" width="13px" height="12px"><g class="rating__fill"><use xlink:href="images/sprite.svg#star-normal"></use></g><g class="rating__stroke"><use xlink:href="images/sprite.svg#star-normal-stroke"></use></g></svg>
                                                        ...
                                                        <svg class="rating__star" width="13px" height="12px"><g class="rating__fill"><use xlink:href="images/sprite.svg#star-normal"></use></g><g class="rating__stroke"><use xlink:href="images/sprite.svg#star-normal-stroke"></use></g></svg>
