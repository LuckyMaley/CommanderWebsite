<%@ Page Title="DashBoard" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true" CodeBehind="DashBoard.aspx.cs" Inherits="CommanderWebsite.Customer.DashBoard" %>
                ...
                <div class="row">
                    <div class="col-12 col-lg-3 d-flex">
                        <div class="account-nav flex-grow-1">
                            ...
                            <ul>
                                <li class="account-nav__item account-nav__item--active"><a href="DashBoard.aspx">Dashboard</a></li>
                        ...
                        <div class="dashboard">
                            <div class="dashboard__profile card profile-card">
                                <div class="card-body profile-card__body">
                                    ...
                                    <div class="profile-card__email">commander@example.com</div>
                                    <div class="profile-card__edit"><a href="EditProfile.aspx" class="btn btn-secondary btn-sm">Edit Profile</a></div>
                                </div>
                            </div>
                            <div class="dashboard__address card address-card address-card--featured">
                                ...
                                <div class="address-card__body">
                                    ...
                                    <div class="address-card__footer"><a href="EditAddress.aspx">Edit Address</a></div>
                                </div>
                            </div>
